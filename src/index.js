...
app.get("/out/*", jsxRenderer(({ children }) => {
    return (_jsxs("html", { children: [_jsxs("head", { children: [_jsx("title", { children: "LinkedOut" }), _jsx("link", { rel: "icon", type: "image/png", href: "/favicon.png" }), _jsx("link", { rel: "stylesheet", href: "/styles.css" }), _jsx("script", { src: "/track.js", defer: true }), _jsx("script", { src: "/qr.js", defer: true })] }), _jsx("body", { class: "base-layout", children: _jsx("div", { children: children }) })] }));
}));

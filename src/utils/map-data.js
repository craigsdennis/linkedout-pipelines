...
export async function getMapData() {
    ...
    const cached = await env.MAP_CACHE.get(MAP_CACHE_KEY, "json");
    ...
    await env.MAP_CACHE.put(MAP_CACHE_KEY, JSON.stringify(mapData), { expirationTtl: CACHE_TTL_SECONDS });
    return mapData;
}
/**
 ...
 */
async function queryLocationStats() {
    try {

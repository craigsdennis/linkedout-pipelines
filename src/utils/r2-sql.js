 ...
 * }
 */
export async function queryR2SQL(query) {
    ...
    try {
        const response = await fetch(`https://api.sql.cloudflarestorage.com/api/v1/accounts/${accountId}/r2-sql/query/linkedout-data-catalog`, {
            method: "POST",
            headers: {
